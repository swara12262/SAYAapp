...
public class JaysingOrg extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_jaysing_org);
        cloth_cb=(CheckBox)findViewById(R.id.j_cloth);
        food_cb= (CheckBox) findViewById(R.id.j_food);
        study_cb= (CheckBox) findViewById(R.id.j_studymaterial);
        volunteer_cb= (CheckBox) findViewById(R.id.j_volunteer);
        oragnise_cb= (CheckBox) findViewById(R.id.j_orgnise);
        other_cb= (CheckBox) findViewById(R.id.j_other);
        helpcontent_edt=(EditText)findViewById(R.id.j_helpcontent_edtxt);
        ...
        ctx=this;
        send_bt=(Button)findViewById(R.id.j_sendmessage_button);
        send_bt.setOnClickListener(this);
    }

    @Override
    public void onClick(View view) {
        if(view.getId()==R.id.j_sendmessage_button)
        {
            helptitle_str="";
           ...
           // Toast.makeText(this.getApplicationContext(),helpcontent_str,Toast.LENGTH_SHORT).show();
            ...
            backgroundTask.execute(method,username_str,helptitle_str,helpcontent_str,"observationhome");
