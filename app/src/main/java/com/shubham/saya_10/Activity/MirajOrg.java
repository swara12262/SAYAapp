...
public class MirajOrg extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_miraj_org);
        cloth_cb=(CheckBox)findViewById(R.id.m_cloth);
        food_cb= (CheckBox) findViewById(R.id.m_food);
        study_cb= (CheckBox) findViewById(R.id.m_studymaterial);
        volunteer_cb= (CheckBox) findViewById(R.id.m_volunteer);
        oragnise_cb= (CheckBox) findViewById(R.id.m_orgnise);
        other_cb= (CheckBox) findViewById(R.id.m_other);
        helpcontent_edt=(EditText)findViewById(R.id.m_helpcontent_edtxt);
        ...
        other_cb.setOnClickListener(this);
         ctx=this;
        send_bt=(Button)findViewById(R.id.m_sendmessage_button);
        send_bt.setOnClickListener(this);
    }

    @Override
    public void onClick(View view) {
        if(view.getId()==R.id.m_sendmessage_button)
        {
            helptitle_str="";
            ...
            backgroundTask.execute(method,username_str,helptitle_str,helpcontent_str,"angel");
